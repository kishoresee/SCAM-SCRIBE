...
class EditItem extends StatelessWidget {
  EditItem(this._shoppingItem, {Key? key}) {
    ...
    _controllerEstimate =
        TextEditingController(text: _shoppingItem['estimate']);
  ...
  late TextEditingController _controllerEstimate;
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                decoration:
                    InputDecoration(hintText: 'Enter the estimate of the item'),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
              ...
              ElevatedButton(
                onPressed: () async {
                  if (_key.currentState!.validate()) {
                    ...
                    String estimate = _controllerEstimate.text;
